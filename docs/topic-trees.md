...
- Your developer environment — _Power Platform Developer Plan environment, Copilot Studio access, VS Code + GitHub Copilot, Snowflake development role; agents use a separate read-only role_
